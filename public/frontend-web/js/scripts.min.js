...
var AjaxHelper = {
    ...
    setLoadWaiting: function (e) {
        var o =
            ...
            hostName +
            '/frontend-web/images/loading-small.gif" alt="loading"><span>Loading...</span></div>';
        if (!0 === e)
...
function findChapter() {
    var searchQuery = $(".chapter-list-modal input").val().toLowerCase().trim();
    var chapters = $(".chapter-list-modal .chapter-list a");
    ...
    chapters.each(function () {
        var chapterText = $(this).text().toLowerCase().replace("chapter ", "").trim();

        // Tìm kiếm nếu chương chứa bất kỳ phần nào của từ khóa
...
if ($(".visited-comics-page").length) {
    if (3 == getParameterByName("t")) populateVisitedComicCloud();
        ...
        } else $(".visited-comics-page").html("Empty");
    }
}
