...
class SearchController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $query = Manga::query()->select('id', 'title', 'alternative_titles', 'slug', 'cover', 'description')
                ->with([
            ...
            if ($sort) {
                if ($sort == 'latest_update') {
                    ...
                    // $query->whereHas('views', function ($query) use ($startMonth) {
                    //     $query->where('updated_at', '>=', $startMonth);
                    // })
                    // ->orderByDesc('views_sum_views');
